...
class H4iHipsolver(CMakePackage):

    homepage = 'https://github.com/CHIP-SPV/H4I-HipSOLVER'
    git = 'https://github.com/CHIP-SPV/H4I-HipSOLVER'
    # url = 'https://github.com/CHIP-SPV/H4I-HipSOLVER/archive/refs/tags/v0.1.0.tar.gz'
