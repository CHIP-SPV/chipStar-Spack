...
class H4iHiputils(CMakePackage):

    homepage = 'https://github.com/CHIP-SPV/H4I-HipUtils'
    git = 'https://github.com/CHIP-SPV/H4I-HipUtils'
    # url = 'https://github.com/CHIP-SPV/H4I-HipUtils/archive/refs/tags/v0.1.0.tar.gz'
